    ...
    for lst in lists:
        if listIndex<2:#0,1
           for alg in algs:
               ...
               #timex = test(alg, lst)
               timex = test(alg, lists[listIndex])
               result = timex
               results[algIndex] = result
               algIndex += 1
...
def maintest2(algs, n):
    ...
    for lst in lists:
        print("Running List", lnames[listIndex])
        #print("LI: ", listIndex)
        if listIndex<2:#0,1
           for alg in algs:
               print(alg.__name__)
    ...
    for lst in lists:
        ...
        if listIndex<2:#0,1
            ...
            for alg in algs:
               print(alg.__name__, ": ", results[algIndex][listIndex][0])#[0]
               #results[algIndex]+=[]
               #print("AI: ", algIndex)
               #result = 0
               #test it and save result
            ...
            for alg in algs:
                ...
                #print(alg.__name__, "mean:", mean, "median:", median)
...
maintest2([bubble_sort, selection_sort, insertion_sort, heapsort, python_sort, quick_sort], 10)
